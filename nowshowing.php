...
<form action="booknow_valid.php" method="POST">
	<center><hr><h3><u><font color="#2414BF">-:<i>NOW SHOWING MOVIES</i>:-</font></u></h3><hr></center>
...
?>
   <br><br><br><br><table  cellpadding="10" border=1 border-color="#2414BF" style="margin-left: 270px;width:50%;padding: 15px;height:50%;border-collapse:collapse ">
    ...
    <td class="list" style="padding-top: 10px;padding-left: 34px;padding-right: 4px;" ><i><font color="#1D6949" ><u><?=$row['name']?></u></font></i></td>
...
?>
  ...
  <button class="button1" onclick="return valid()">Book Now</button>
</form>
